...
train_ex = sacred.Experiment("generate_rollouts", interactive=True)
...
def train_defaults():
  ...
  dac = False
  rollout_save_n_episodes = 1000  # Num episodes saved per file, optional.
  ...
  init_trainer_kwargs = dict(
      ...
      num_vec=1,  # Must evenly divide gen_batch_size
  ...
  log_root = os.path.join('/serverdata/sid/reward_bias/imitation', "output", "train_adversarial")  # output directory
